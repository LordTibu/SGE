...
public interface IEmployeeRepository : IRepository<Employee>
{
    ...
    /// The task result contains the employee that matches the specified
    /// email address, or null if no match is found.
    /// </returns>
    ...
    /// <summary>
    /// Retrieves an employee entity along with its associated department
    ...
    /// <returns>
    /// A task representing the asynchronous operation.
    /// The task result contains the employee entity with its department
    /// data, or null if no match is found.
    /// </returns>
    ...
    /// contains an enumerable collection of employees for the specified page.
    /// </returns>
