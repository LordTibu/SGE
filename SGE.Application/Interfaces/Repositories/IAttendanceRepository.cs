...
namespace SGE.Application.Interfaces.Repositories
{
    ...
    /// offering functionality to interact with attendance data specific to
    /// employees.
    /// </summary>
    public interface IAttendanceRepository : IRepository<Attendance>
    {
        ...
        /// A token for propagating notification that the operation should be canceled.
        /// </param>
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains a collection
        /// of <see cref="Attendance"/> records for the specified employee.
        /// </returns>
