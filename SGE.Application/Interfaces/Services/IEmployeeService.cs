...
public interface IEmployeeService
{
    ...
    /// </returns>
    Task<IEnumerable<EmployeeDto>> GetAllAsync(CancellationToken
    ...
    /// </returns>
    Task<EmployeeDto?> GetByIdAsync(int id, CancellationToken
        cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the employee data transfer object (EmployeeDto) if found, otherwise null.
    /// </returns>
    Task<EmployeeDto?> GetByEmailAsync(string email, CancellationToken
        cancellationToken = default);
    ...
    Task<IEnumerable<EmployeeDto>>
        GetByDepartmentAsync(int departmentId, CancellationToken
            cancellationToken = default);
