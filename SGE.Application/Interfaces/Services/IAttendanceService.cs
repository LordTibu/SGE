...
namespace SGE.Application.Interfaces.Services
{
    ...
    public interface IAttendanceService
    {
        ...
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains the attendance
        /// details after clock-in.
        /// </returns>
        ...
        /// An object containing the details for the attendance record such as employee ID, date, clock-in
        /// time, clock-out time, break duration, and notes.
        /// </param>
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains the details
        /// of the created attendance record.
        /// </returns>
        ...
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains the attendance
        /// details for the specified ID, or null if no record is found.
        /// </returns>
        ...
        /// of attendance records matching the query parameters.
        /// </returns>
        ...
        /// of attendance details for the specified date.
        /// </returns>
        ...
        /// for the current day, or null if no attendance record exists.
        /// </returns>
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains the total worked hours as a decimal value.
        /// </returns>
