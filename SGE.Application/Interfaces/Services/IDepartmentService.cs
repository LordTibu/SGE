...
public interface IDepartmentService
{
    ...
    /// The task result contains an enumerable collection of <see cref="DepartmentDto"/>.
    /// </returns>
    ...
    /// <returns>
    /// A task representing the asynchronous operation. 
    /// The task result contains the <see cref="DepartmentDto"/> for the specified identifier, or null if not found.
    /// </returns>
    ...
    /// <returns>
    /// A task representing the asynchronous operation. 
    /// The task result contains the newly created <see cref="DepartmentDto"/>.
    /// </returns>
