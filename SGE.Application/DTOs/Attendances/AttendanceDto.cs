namespace SGE.Application.DTOs.Attendances
{
    public class AttendanceDto
    {
        ...
        /// <summary>
        /// Gets or sets the number of hours worked beyond the standard
        /// working hours.
        /// </summary>
        public decimal OvertimeHours { get; set; }

        /// <summary>
        /// Gets or sets any additional notes or comments associated with
        /// the attendance record.
        /// </summary>
        public string Notes { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the timestamp indicating when the attendance record
        /// was created.
        /// </summary>
