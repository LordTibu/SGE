...
/// <summary>
/// Provides database operations for the <see cref="Department"/> entity. 
/// Implements methods for retrieving departments by their name or code, 
/// including all inherited methods from the generic repository.
/// </summary>
public class DepartmentRepository : Repository<Department>, IDepartmentRepository
{
    /// <summary>
    /// Repository implementation for handling <see cref="Department"/>-related database operations.
    ...
    /// Searches the database for a department with a matching name and
    ...
    /// The task result contains the department entity if found; otherwise, null.
    /// </returns>
    ...
    /// The task result contains the <see cref="Department"/> entity that matches 
    /// the specified code, or null if no match is found.
    /// </returns>
