...
namespace SGE.Infrastructure.Repositories
{
    ...
    {
        /// <summary>
        /// Defines a repository that provides data access capabilities for
        /// Attendance entities.
        /// Extends the generic Repository base class and implements the
        ...
        /// </param>
        /// <returns>
        /// A task representing the asynchronous operation, with a collection of Attendance entities
