...
/// <summary>
/// Handles HTTP requests related to department operations such as retrieving,
...
public class DepartmentsController : ControllerBase
{
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>
    /// An <see cref="ActionResult"/> containing the <see cref="DepartmentDto"/> of the specified department
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>
    /// An <see cref="ActionResult"/> containing the created <see cref="DepartmentDto"/> with its unique
